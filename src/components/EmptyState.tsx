...
function CoralIllustration({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Background bubbles */}
      <circle cx="30" cy="30" r="4" fill="var(--color-coral-400, #4ecdc4)" fillOpacity="0.2">
        <animate attributeName="cy" values="30;20;30" dur="3s" repeatCount="indefinite" />
      </circle>
      <circle cx="170" cy="50" r="3" fill="var(--color-coral-400, #4ecdc4)" fillOpacity="0.15">
        <animate attributeName="cy" values="50;40;50" dur="4s" repeatCount="indefinite" />
      </circle>
      <circle cx="50" cy="60" r="2" fill="var(--color-gold-400, #f0c850)" fillOpacity="0.2">
        <animate attributeName="cy" values="60;50;60" dur="2.5s" repeatCount="indefinite" />
      </circle>
      <circle cx="150" cy="25" r="2.5" fill="var(--color-coral-400, #4ecdc4)" fillOpacity="0.15">
      ...
      <g transform="translate(80, 60)">
        <path d="M20 80 Q20 60, 10 40 Q5 30, 15 20 Q20 15, 15 5" stroke="var(--color-mote-400, #ee7996)" strokeWidth="4" strokeLinecap="round" fill="none" />
        <path d="M20 80 Q25 55, 35 35 Q40 25, 35 15 Q30 8, 40 0" stroke="var(--color-mote-400, #ee7996)" strokeWidth="4" strokeLinecap="round" fill="none" />
        <path d="M20 80 Q15 65, 5 50" stroke="var(--color-mote-400, #ee7996)" strokeWidth="3" strokeLinecap="round" fill="none" />
        <path d="M20 80 Q30 70, 45 55" stroke="var(--color-mote-400, #ee7996)" strokeWidth="3" strokeLinecap="round" fill="none" />
        {/* Coral polyps */}
        <circle cx="15" cy="5" r="4" fill="var(--color-mote-400, #ee7996)" fillOpacity="0.6" />
        <circle cx="40" cy="0" r="4" fill="var(--color-mote-400, #ee7996)" fillOpacity="0.6" />
        <circle cx="5" cy="50" r="3" fill="var(--color-mote-400, #ee7996)" fillOpacity="0.6" />
        <circle cx="45" cy="55" r="3" fill="var(--color-mote-400, #ee7996)" fillOpacity="0.6" />
        <circle cx="10" cy="40" r="2" fill="var(--color-mote-400, #ee7996)" fillOpacity="0.4" />
        <circle cx="35" cy="35" r="2" fill="var(--color-mote-400, #ee7996)" fillOpacity="0.4" />
      </g>

      {/* Brain coral */}
      <g transform="translate(30, 100)">
        <ellipse cx="25" cy="25" rx="25" ry="20" fill="var(--color-coral-400, #4ecdc4)" fillOpacity="0.3" />
        <path d="M10 20 Q25 15, 40 20" stroke="var(--color-coral-400, #4ecdc4)" strokeWidth="2" fill="none" />
        <path d="M8 28 Q25 22, 42 28" stroke="var(--color-coral-400, #4ecdc4)" strokeWidth="2" fill="none" />
        <path d="M12 35 Q25 30, 38 35" stroke="var(--color-coral-400, #4ecdc4)" strokeWidth="2" fill="none" />
      </g>

      {/* Fan coral */}
      <g transform="translate(140, 80)">
        <path d="M15 50 Q15 35, 0 20 Q-5 15, 0 10" stroke="var(--color-gold-400, #f0c850)" strokeWidth="2" strokeLinecap="round" fill="none" />
        <path d="M15 50 Q18 30, 15 15 Q15 8, 20 5" stroke="var(--color-gold-400, #f0c850)" strokeWidth="2" strokeLinecap="round" fill="none" />
        <path d="M15 50 Q25 35, 35 20 Q40 12, 35 5" stroke="var(--color-gold-400, #f0c850)" strokeWidth="2" strokeLinecap="round" fill="none" />
        <path d="M15 50 Q10 40, 5 30" stroke="var(--color-gold-400, #f0c850)" strokeWidth="1.5" strokeLinecap="round" fill="none" />
        <path d="M15 50 Q20 40, 25 30" stroke="var(--color-gold-400, #f0c850)" strokeWidth="1.5" strokeLinecap="round" fill="none" />
      </g>

      {/* Small fish */}
      <g transform="translate(60, 45)">
        <ellipse cx="10" cy="5" rx="8" ry="4" fill="var(--color-coral-400, #4ecdc4)" fillOpacity="0.4">
          <animateTransform attributeName="transform" type="translate" values="0,0; 10,-5; 20,0; 10,5; 0,0" dur="8s" repeatCount="indefinite" />
        </ellipse>
        <path d="M18 5 L25 2 L25 8 Z" fill="var(--color-coral-400, #4ecdc4)" fillOpacity="0.4">
          <animateTransform attributeName="transform" type="translate" values="0,0; 10,-5; 20,0; 10,5; 0,0" dur="8s" repeatCount="indefinite" />
        </path>
      </g>

      {/* Seaweed */}
      <path d="M170 140 Q165 120, 175 100 Q180 90, 170 80" stroke="var(--color-coral-400, #4ecdc4)" strokeWidth="3" strokeLinecap="round" fill="none" opacity="0.4">
      ...
      <path d="M180 140 Q185 125, 175 110 Q170 100, 180 90" stroke="var(--color-coral-400, #4ecdc4)" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.3">
      ...
      <svg viewBox="0 0 1200 30" preserveAspectRatio="none" className="w-full h-full">
        ...
        <defs>
          <linearGradient id="waveGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="var(--color-coral-400, #4ecdc4)" />
            <stop offset="50%" stopColor="var(--color-gold-400, #f0c850)" />
            <stop offset="100%" stopColor="var(--color-coral-400, #4ecdc4)" />
          </linearGradient>
        </defs>
      </svg>
    </div>
